...
public class RaceDao extends RaceDaoAbstract {
    ...
    public static final String SHOW_ALL_RACES_SQL = "SELECT id, hippodrome, time, race_type FROM races INNER JOIN races_has_horses " +
    ...
    public Optional<Race> create(Race race) throws DaoException {
        try (var connection = ConnectionManager.get();
            ...
            preparedStatement.setObject(2, race.getDateTime());
    ...
    public Optional<Race> read(Long id) throws DaoException {
        try(var connection = ConnectionManager.get();
            ...
            while (resultSet.next()) {
                ...
                race.setDateTime(resultSet.getTimestamp("time").toLocalDateTime());
    ...
    private List<Race> findAll(String sql, int limit, int offset) throws DaoException {
        ...
        try (var connection = ConnectionManager.get();
            ...
            while (resultSet.next()) {
                ...
                races.add(new Race(id, hippodrome, raceType, horse, date));
            }
            return races;
        } catch (SQLException e) {
